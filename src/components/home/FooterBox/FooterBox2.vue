<template>
	<footer class=" bg-blue-200 px-4 divide-y dark:bg-gray-100 dark:text-gray-800">
    ...
    ref="footerRef">
			<div class="lg:w-1/3">
				<a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
					<div class="flex items-center justify-center w-12 h-12 rounded-full dark:bg-emerald-600">
		...
		<div class="p-4 h-10 text-center">© 1968 Company Co. All rights reserved.</div>
	</footer>
</template>
<script setup>
...
const handleWheel = (event) => {
  ...
  if (currentScrollY > lastScrollY && !isContentVisible.value) {
    isContentVisible.value = true; // Downward scroll to show
  } else if (currentScrollY < lastScrollY && isContentVisible.value) {
    isContentVisible.value = false; // Upward scroll to hide
  }
